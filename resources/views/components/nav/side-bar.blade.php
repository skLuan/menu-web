<div id="sideBarContainer" class="">
    <div id="sideBar"
        ...
        <div class="text-gray text-[22px] font-medium flex flex-col my-auto">
            <a class="py-2" href="{{route('home', app()->getLocale()) }}">Restaurante</a>
            <a class="py-2" href="{{ route('reserve', app()->getLocale()) }}">Reservas</a>
            <a class="py-2" href="{{route('menu', app()->getLocale()) }}">Menu</a>
        </div>
        {{-- @if ($routeName === 'home')
        @endif --}}
    </div>
